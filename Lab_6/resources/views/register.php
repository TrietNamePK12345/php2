        ...
        <div class="row">
            ...
            <div class="col-xxl-4 col-xl-5 col-lg-6 col-sm-8 mx-auto">
                <div class="log-in-box">
                    ...
                    <div class="input-box">
                        <form class="row g-4" action="/dang-ki-nguoi-dung" method="post">
                            <div class="col-12">
                                <div class="form-floating theme-form-floating">
                                    <input type="text" name="fullname" class="form-control" id="fullname" placeholder="Họ và tên" value="<?= !empty($old['fullname']) ? $old['fullname'] : false ?>" >
                            ...
                            <div class="col-12">
                                <div class="form-floating theme-form-floating">
                                    <input type="email" name="email" class="form-control" id="email" placeholder="Email" value="<?= !empty($old['email']) ? $old['email'] : false ?>" >
                                    <label>Email</label>
                                </div>
                            </div>
