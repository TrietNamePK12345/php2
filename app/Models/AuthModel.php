...
class AuthModel extends Model
{
    ...
    public function ConfirmCode($email, $token_hash, $expiry)
    {
        $result = self::$db->table('users')->where('email', '=', $email)->update(['confirmation_code' => $token_hash, 'reset_token' => $expiry]);
        return $result;
    }
