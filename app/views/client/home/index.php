                    ...
                    <div class="col-12">
                        <div class="navbar-top">
                            ...
                            <a href="index.html" class="web-logo nav-logo">
                                <img src="<?= _WEB_ROOT ?>/public/assets/client/images/logo/1.png" class="img-fluid blur-up lazyload" alt="">
                            </a>
                                            ...
                                            <div class="onhover-div">
                                                <ul class="cart-list">
                                                    <li class="product-box-contain">
                                                        <div class="drop-cart">
                                                            <a href="product-left-thumbnail.html" class="drop-image">
                                                                <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/1.png" class="blur-up lazyload" alt="">
                                                            </a>
                                                    ...
                                                    <li class="product-box-contain">
                                                        <div class="drop-cart">
                                                            <a href="product-left-thumbnail.html" class="drop-image">
                                                                <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/2.png" class="blur-up lazyload" alt="">
                                                            </a>
                                    ...
                                    <li class="right-side onhover-dropdown">
                                        ...
                                        <div class="onhover-div onhover-div-login">
                                            <ul class="user-box-name">
                                                <li class="product-box-contain">
                                                    <i></i>
                                                    <a href="dang-nhap">Log In</a>
                                                </li>

                                                <li class="product-box-contain">
                                                    <a href="dang-ki">Register</a>
                                                </li>
                                ...
                                <ul class="category-list">
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="<?= _WEB_ROOT ?>/public/assets/client/svg/1/vegetable.svg" alt="">
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="<?= _WEB_ROOT ?>/public/assets/client/svg/1/cup.svg" alt="">
                                            <h6>Beverages</h6>
                                            <i class="fa-solid fa-angle-right"></i>
                                        </a>
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="<?= _WEB_ROOT ?>/public/assets/client/svg/1/meats.svg" alt="">
                                            <h6>Meats & Seafood</h6>
                                            <i class="fa-solid fa-angle-right"></i>
                                        </a>
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="<?= _WEB_ROOT ?>/public/assets/client/svg/1/breakfast.svg" alt="">
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="<?= _WEB_ROOT ?>/public/assets/client/svg/1/frozen.svg" alt="">
                                            <h6>Frozen Foods</h6>
                                            <i class="fa-solid fa-angle-right"></i>
                                        </a>
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="<?= _WEB_ROOT ?>/public/assets/client/svg/1/biscuit.svg" alt="">
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="<?= _WEB_ROOT ?>/public/assets/client/svg/1/grocery.svg" alt="">
            ...
            <div class="row g-4">
                <div class="col-xl-8 ratio_65">
                    <div class="home-contain h-100">
                        <div class="h-100">
                            <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/banner/1.jpg" class="bg-img blur-up lazyload" alt="">
                        </div>
                    ...
                    <div class="row g-4">
                        <div class="col-xl-12 col-md-6">
                            <div class="home-contain">
                                <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/banner/2.jpg" class="bg-img blur-up lazyload" alt="">
                                <div class="home-detail p-center-left home-p-sm w-75">
                                    <div>
                                        ...
                                        <a href="shop-left-sidebar.html" class="shop-button">Shop Now <i class="fa-solid fa-right-long"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-12 col-md-6">
                            <div class="home-contain">
                                <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/banner/3.jpg" class="bg-img blur-up lazyload" alt="">
                                <div class="home-detail p-center-left home-p-sm w-75">
                                    <div>
            ...
            <div class="banner-slider">
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/banner/4.jpg" class="bg-img blur-up lazyload" alt="">
                        <div class="banner-details">
                            ...
                            <a href="shop-left-sidebar.html" class="banner-button text-white">Shop Now <i class="fa-solid fa-right-long ms-2"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/banner/5.jpg" class="bg-img blur-up lazyload" alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                                <h6 class="text-danger">5% OFF</h6>
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/banner/6.jpg" class="bg-img blur-up lazyload" alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                                <h6 class="text-danger">5% OFF</h6>
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/banner/7.jpg" class="bg-img blur-up lazyload" alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                                <h6 class="text-danger">5% OFF</h6>
                                <h5>Buy More & Save More</h5>
                    ...
                    <div class="p-sticky">
                            ...
                            <ul>
                                <li>
                                    <div class="category-list">
                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/svg/1/vegetable.svg" class="blur-up lazyload" alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/svg/1/cup.svg" class="blur-up lazyload" alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/svg/1/meats.svg" class="blur-up lazyload" alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/svg/1/breakfast.svg" class="blur-up lazyload" alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/svg/1/frozen.svg" class="blur-up lazyload" alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/svg/1/biscuit.svg" class="blur-up lazyload" alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/svg/1/grocery.svg" class="blur-up lazyload" alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/svg/1/drink.svg" class="blur-up lazyload" alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/svg/1/milk.svg" class="blur-up lazyload" alt="">
                                        <h5>
                                ...
                                <li class="pb-30">
                                    <div class="category-list">
                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/svg/1/pet.svg" class="blur-up lazyload" alt="">
                                        <h5>
                        ...
                        <div class="ratio_156 section-t-space">
                            <div class="home-contain hover-effect">
                                <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/banner/8.jpg" class="bg-img blur-up lazyload" alt="">
                        ...
                        <div class="ratio_medium section-t-space">
                            <div class="home-contain hover-effect">
                                <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/banner/11.jpg" class="img-fluid blur-up lazyload" alt="">
                                <div class="home-detail p-top-left home-p-medium">
                                    <div>
                            ...
                            <div class="category-menu">
                                ...
                                <ul class="product-list border-0 p-0 d-block">
                                    <li>
                                        <div class="offer-product">
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/23.png" class="blur-up lazyload" alt="">
                                            </a>
                                    ...
                                    <li>
                                        <div class="offer-product">
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/24.png" class="blur-up lazyload" alt="">
                                            </a>
                                    ...
                                    <li>
                                        <div class="offer-product">
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/25.png" class="blur-up lazyload" alt="">
                                            </a>
                                    ...
                                    <li class="mb-0">
                                        <div class="offer-product">
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/26.png" class="blur-up lazyload" alt="">
                                            </a>
                                ...
                                <div class="review-box">
                                    ...
                                    <div class="review-profile">
                                        <div class="review-image">
                                            <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/review/1.jpg" class="img-fluid blur-up lazyload" alt="">
                                        </div>
                ...
                <div class="col-xxl-9 col-xl-8">
                                    ...
                                    <div class="row m-0">
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/1.png" class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                        ...
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/2.png" class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                                                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#view">
                                    ...
                                    <div class="row m-0">
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/3.png" class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                                                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#view">
                                        ...
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                ...
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/4.png" class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                                                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#view">
                                    ...
                                    <div class="row m-0">
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/5.png" class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                                                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#view">
                                        ...
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/6.png" class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                                                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#view">
                                    ...
                                    <div class="row m-0">
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                ...
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/7.png" class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                                                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#view">
                                        ...
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/8.png" class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                                                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#view">
                                    ...
                                    <div class="row m-0">
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/9.png" class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                                                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#view">
                                        ...
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/10.png" class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                                                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#view">
                    ...
                    <div class="section-t-space section-b-space">
                        <div class="row g-md-4 g-3">
                            <div class="col-md-6">
                                <div class="banner-contain hover-effect">
                                    <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/banner/9.jpg" class="bg-img blur-up lazyload" alt="">
                            ...
                            <div class="col-md-6">
                                <div class="banner-contain hover-effect">
                                    <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/banner/10.jpg" class="bg-img blur-up lazyload" alt="">
                                    <div class="banner-details p-center-left p-4">
                                        <div>
                                            <h3 class="text-exo">50% offer</h3>
                    ...
                    <div class="section-t-space">
                        <div class="banner-contain">
                            <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/banner/15.jpg" class="bg-img blur-up lazyload" alt="">
                    ...
                    <div class="section-t-space section-b-space">
                        <div class="row g-md-4 g-3">
                            <div class="col-xxl-8 col-xl-12 col-md-7">
                                <div class="banner-contain hover-effect">
                                    <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/banner/12.jpg" class="bg-img blur-up lazyload" alt="">
                                    <div class="banner-details p-center-left p-4">
                                        <div>
                            ...
                            <div class="col-xxl-4 col-xl-12 col-md-5">
                                <a href="shop-left-sidebar.html" class="banner-contain hover-effect h-100">
                                    <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/banner/13.jpg" class="bg-img blur-up lazyload" alt="">
                        ...
                        <div>
                            <ul class="product-list">
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/11.png" class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/12.png" class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/13.png" class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/14.png" class="blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <ul class="product-list">
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/15.png" class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/16.png" class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/17.png" class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/18.png" class="blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <ul class="product-list">
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/19.png" class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/20.png" class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/21.png" class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/22.png" class="blur-up lazyload" alt="">
                                        </a>
                    ...
                    <div class="section-t-space">
                        <div class="banner-contain hover-effect">
                            <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/banner/14.jpg" class="bg-img blur-up lazyload" alt="">
                    ...
                    <div class="slider-3-blog ratio_65 no-arrow product-wrapper">
                            ...
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/blog/1.jpg" class="bg-img blur-up lazyload" alt="">
                                    </a>
                                </div>
                        ...
                        <div>
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/blog/2.jpg" class="bg-img blur-up lazyload" alt="">
                                    </a>
                                </div>
                        ...
                        <div>
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/blog/3.jpg" class="bg-img blur-up lazyload" alt="">
                                    </a>
                                </div>
                        ...
                        <div class="service-contain">
                            <div class="service-box">
                                <div class="service-image">
                                    <img src="<?= _WEB_ROOT ?>/public/assets/client/svg/product.svg" class="blur-up lazyload" alt="">
                                </div>
                            ...
                            <div class="service-box">
                                <div class="service-image">
                                    <img src="<?= _WEB_ROOT ?>/public/assets/client/svg/delivery.svg" class="blur-up lazyload" alt="">
                                </div>
                            ...
                            <div class="service-box">
                                <div class="service-image">
                                    <img src="<?= _WEB_ROOT ?>/public/assets/client/svg/discount.svg" class="blur-up lazyload" alt="">
                                </div>
                            ...
                            <div class="service-box">
                                <div class="service-image">
                                    <img src="<?= _WEB_ROOT ?>/public/assets/client/svg/market.svg" class="blur-up lazyload" alt="">
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="footer-logo">
                            <div class="theme-logo">
                                <a href="index.html">
                                    <img src="<?= _WEB_ROOT ?>/public/assets/client/images/logo/1.png" class="blur-up lazyload" alt="">
                                </a>
                            </div>
                                    ...
                                    <ul>
                                        <li class="mb-0">
                                            <a href="https://play.google.com/store/apps" target="_blank">
                                                <img src="<?= _WEB_ROOT ?>/public/assets/client/images/playstore.svg" class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                        <li class="mb-0">
                                            <a href="https://www.apple.com/in/app-store/" target="_blank">
                                                <img src="<?= _WEB_ROOT ?>/public/assets/client/images/appstore.svg" class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                            ...
                            <li class="list-1">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="<?= _WEB_ROOT ?>/public/assets/client/images/vegetable/product/10.png" class="blur-up lazyload" alt="">
                                    </a>
