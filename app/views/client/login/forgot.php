                                    ...
                                    <div class="offcanvas-body">
                                        <ul class="navbar-nav">
                                            ...
                                            <li class="nav-item dropdown dropdown-mega">
                                                <a class="nav-link dropdown-toggle ps-xl-2 ps-0" href="" data-bs-toggle="dropdown">Mega Menu</a>
        ...
        <div class="row">
            <div class="col-xxl-6 col-xl-5 col-lg-6 d-lg-block d-none ms-auto">
                <div class="image-contain">
                    <img src="<?=_WEB_ROOT?>/public/assets/client/images/inner-page/forgot.png" class="img-fluid" alt="">
                </div>
            </div>
                ...
                <div class="d-flex align-items-center justify-content-center h-100">
                    <div class="log-in-box">
                        <div class="log-in-title">
                            <h3>Chào Mừng Đến Với Fantasy</h3>
