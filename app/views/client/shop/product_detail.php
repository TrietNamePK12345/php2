<body>
                                            ...
                                            <div class="onhover-div">
                                                <ul class="cart-list">
                                                    <li class="product-box-contain">
                                                        <div class="drop-cart">
                                                            <a href="product-left-thumbnail.html" class="drop-image">
                                                                <img src="<?=_WEB_ROOT?>/public/assets/client/images/vegetable/product/1.png"
                                                    ...
                                                    <li class="product-box-contain">
                                                        <div class="drop-cart">
                                                            <a href="product-left-thumbnail.html" class="drop-image">
                                                                <img src="<?=_WEB_ROOT?>/public/assets/client/images/vegetable/product/2.png"
                                                                    class="blur-up lazyload" alt="">
                                                            </a>
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li class="sub-dropdown-hover">
                                                        <a href="" class="dropdown-item">Product
                                                            Thumbnail</a>
                                                        <ul class="sub-menu">
                                                            <li>
                                        ...
                                        <div class="product-main-2 no-arrow">
                                            <div>
                                                <div class="slider-image">
                                                    <img src="<?=_WEB_ROOT?>/public/assets/client/images/product/category/1.jpg" id="img-1"
                                                        data-zoom-image="<?=_WEB_ROOT?>/public/assets/client/images/product/category/1.jpg"
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="<?=_WEB_ROOT?>/public/assets/client/images/product/category/2.jpg"
                                                        data-zoom-image="<?=_WEB_ROOT?>/public/assets/client/images/product/category/2.jpg"
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="<?=_WEB_ROOT?>/public/assets/client/images/product/category/3.jpg"
                                                        data-zoom-image="<?=_WEB_ROOT?>/public/assets/client/images/product/category/3.jpg"
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="<?=_WEB_ROOT?>/public/assets/client/images/product/category/4.jpg"
                                                        data-zoom-image="<?=_WEB_ROOT?>/public/assets/client/images/product/category/4.jpg"
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="<?=_WEB_ROOT?>/public/assets/client/images/product/category/5.jpg"
                                                        data-zoom-image="<?=_WEB_ROOT?>/public/assets/client/images/product/category/5.jpg"
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="<?=_WEB_ROOT?>/public/assets/client/images/product/category/6.jpg"
                                                        data-zoom-image="<?=_WEB_ROOT?>/public/assets/client/images/product/category/6.jpg"
                                        ...
                                        <div class="left-slider-image-2 left-slider no-arrow slick-top">
                                            <div>
                                                <div class="sidebar-image">
                                                    <img src="<?=_WEB_ROOT?>/public/assets/client/images/product/category/1.jpg"
                            ...
                            <div class="right-box-contain">
                                ...
                                <div class="pickup-box">
                                    ...
                                    <div class="product-info">
                                        <ul class="product-info-list product-info-list-2">
                                            <li>Type : <a href="">Black Forest</a></li>
                                            <li>SKU : <a href="">SDFVW65467</a></li>
                                            <li>MFG : <a href="">Jun 4, 2022</a></li>
                                            <li>Stock : <a href="">2 Items Left</a></li>
                                            <li>Tags : <a href="">Cake,</a> <a
                                                    href="">Backery</a></li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="paymnet-option">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="">
                                                <img src="<?=_WEB_ROOT?>/public/assets/client/images/product/payment/1.svg"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="">
                                                <img src="<?=_WEB_ROOT?>/public/assets/client/images/product/payment/2.svg"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="">
                                                <img src="<?=_WEB_ROOT?>/public/assets/client/images/product/payment/3.svg"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="">
                                                <img src="<?=_WEB_ROOT?>/public/assets/client/images/product/payment/4.svg"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="">
                                                <img src="<?=_WEB_ROOT?>/public/assets/client/images/product/payment/5.svg"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                                        ...
                                        <div class="product-description">
                                            ...
                                            <div class="banner-contain nav-desh">
                                                <img src="<?=_WEB_ROOT?>/public/assets/client/images/vegetable/banner/14.jpg"
                                                        ...
                                                        <ul class="review-list">
                                                                ...
                                                                <div class="people-box">
                                                                    <div>
                                                                        <div class="people-image">
                                                                            <img src="<?=_WEB_ROOT?>/public/assets/client/images/review/1.jpg"
                                                            ...
                                                            <li>
                                                                <div class="people-box">
                                                                    <div>
                                                                        <div class="people-image">
                                                                            <img src="<?=_WEB_ROOT?>/public/assets/client/images/review/2.jpg"
                                                                                class="img-fluid blur-up lazyload"
                                                                                alt="">
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <li>
                                                                <div class="people-box">
                                                                    <div>
                                                                        <div class="people-image">
                                                                            <img src="<?=_WEB_ROOT?>/public/assets/client/images/review/3.jpg"
                                                                                class="img-fluid blur-up lazyload"
                                                                                alt="">
                                                                        </div>
                                                                    </div>
                    ...
                    <div class="right-sidebar-box">
                        <div class="vendor-box">
                            <div class="verndor-contain">
                                <div class="vendor-image">
                                    <img src="<?=_WEB_ROOT?>/public/assets/client/images/product/vendor.png" class="blur-up lazyload" alt="">
                                </div>
                            ...
                            <div class="category-menu">
                                ...
                                <ul class="product-list product-right-sidebar border-0 p-0">
                                    <li>
                                        <div class="offer-product">
                                            ...
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="<?=_WEB_ROOT?>/public/assets/client/images/vegetable/product/23.png"
                                                    class="img-fluid blur-up lazyload" alt="">
                                            </a>
                                    ...
                                    <li>
                                        <div class="offer-product">
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="<?=_WEB_ROOT?>/public/assets/client/images/vegetable/product/24.png"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                    ...
                                    <li>
                                        <div class="offer-product">
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="<?=_WEB_ROOT?>/public/assets/client/images/vegetable/product/25.png"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                    ...
                                    <li class="mb-0">
                                        <div class="offer-product">
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="<?=_WEB_ROOT?>/public/assets/client/images/vegetable/product/26.png"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                        ...
                        <div class="ratio_156 pt-25">
                            <div class="home-contain">
                                <img src="<?=_WEB_ROOT?>/public/assets/client/images/vegetable/banner/8.jpg" class="bg-img blur-up lazyload"
                                    alt="">
            ...
            <div class="title">
                ...
                <span class="title-leaf">
                    <svg class="icon-width">
                        <use xlink:href="<?=_WEB_ROOT?>/public/assets/client/svg/leaf.svg#leaf"></use>
                    </svg>
                </span>
            </div>
            <div class="row">
                                ...
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left.htm">
                                            <img src="<?=_WEB_ROOT?>/public/assets/client/images/cake/product/11.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.05s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="<?=_WEB_ROOT?>/public/assets/client/images/cake/product/2.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="<?=_WEB_ROOT?>/public/assets/client/images/cake/product/3.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.15s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="<?=_WEB_ROOT?>/public/assets/client/images/cake/product/4.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.2s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="<?=_WEB_ROOT?>/public/assets/client/images/cake/product/5.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.25s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="<?=_WEB_ROOT?>/public/assets/client/images/cake/product/6.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="<?=_WEB_ROOT?>/public/assets/client/images/cake/product/7.png" class="img-fluid" alt="">
                                        </a>
        ...
        <div class="container-fluid-lg">
                                    ...
                                    <ul>
                                        <li class="mb-0">
                                            <a href="https://play.google.com/store/apps" target="_blank">
                                                <img src="<?=_WEB_ROOT?>/public/assets/client/images/playstore.svg" class="blur-up lazyload"
                                                    alt="">
                                            </a>
                                        </li>
                                        <li class="mb-0">
                                            <a href="https://www.apple.com/in/app-store/" target="_blank">
                                                <img src="<?=_WEB_ROOT?>/public/assets/client/images/appstore.svg" class="blur-up lazyload"
                                                    alt="">
                                            </a>
                                        </li>
                                    </ul>
            ...
            <div class="sub-footer section-small-space">
                ...
                <div class="payment">
                    ...
                    <img src="<?=_WEB_ROOT?>/public/assets/client/images/payment/1.png" class="blur-up lazyload" alt="">
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row g-sm-4 g-2">
                        <div class="col-lg-6">
                            <div class="slider-image">
                                <img src="<?=_WEB_ROOT?>/public/assets/client/images/product/category/1.jpg" class="img-fluid blur-up lazyload"
                                    alt="">
                            </div>
                        </div>
                    ...
                    <div class="deal-offer-box">
                        <ul class="deal-offer-list">
                            <li class="list-1">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="<?=_WEB_ROOT?>/public/assets/client/images/vegetable/product/10.png" class="blur-up lazyload"
                                            alt="">
                                    </a>
                            ...
                            <li class="list-2">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="<?=_WEB_ROOT?>/public/assets/client/images/vegetable/product/11.png" class="blur-up lazyload"
                                            alt="">
                                    </a>
                            ...
                            <li class="list-3">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="<?=_WEB_ROOT?>/public/assets/client/images/vegetable/product/12.png" class="blur-up lazyload"
                                            alt="">
                                    </a>
                            ...
                            <li class="list-1">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="<?=_WEB_ROOT?>/public/assets/client/images/vegetable/product/13.png" class="blur-up lazyload"
                                            alt="">
                                    </a>
    ...
    <div class="add-cart-box">
        <div class="add-iamge">
            <img src="<?=_WEB_ROOT?>/public/assets/client/images/cake/pro/1.jpg" class="img-fluid" alt="">
        </div>
