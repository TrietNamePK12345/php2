<body>
                    ...
                    <div class="left-box">
                        <div class="shop-left-sidebar">
                            ...
                            <div class="filter-category">
                                ...
                                <ul>
                                    <li>
                                        <a href="">Vegetable <i class="fa-solid fa-x"></i></a>
                                    </li>
                                    <li>
                                        <a href="">Fruit <i class="fa-solid fa-x"></i></a>
                                    </li>
                                    <li>
                                        <a href="">Fresh <i class="fa-solid fa-x"></i></a>
                                    </li>
                                    <li>
                                        <a href="">Milk <i class="fa-solid fa-x"></i></a>
                                    </li>
                                    <li>
                                        <a href="">Meat <i class="fa-solid fa-x"></i></a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div>
                            <div class="product-box-3 h-100 wow fadeInUp" data-wow-delay="0.25s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="<?=_WEB_ROOT?>/public/assets/client/images/cake/product/7.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
    ...
    <div class="add-cart-box">
        <div class="add-iamge">
            <img src="<?=_WEB_ROOT?>/public/assets/client/images/cake/pro/1.jpg" class="img-fluid blur-up lazyload" alt="">
        </div>
