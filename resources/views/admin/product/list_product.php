                                    ...
                                    <div class="table-responsive">
                                        <table class="table all-package theme-table table-product" id="table_id">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="table-image">
                                                        <img src="<?=_WEB_ROOT?>assets/admin/images/product/1.png" class="img-fluid"
                                                             alt="">
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="table-image">
                                                        <img src="<?=_WEB_ROOT?>assets/admin/images/product/2.png" class="img-fluid"
                                                             alt="">
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="table-image">
                                                        <img src="<?=_WEB_ROOT?>assets/admin/images/product/3.png" class="img-fluid"
                                                             alt="">
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="table-image">
                                                        <img src="<?=_WEB_ROOT?>assets/admin/images/product/4.png" class="img-fluid"
                                                             alt="">
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="table-image">
                                                        <img src="<?=_WEB_ROOT?>assets/admin/images/product/5.png" class="img-fluid"
                                                             alt="">
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="table-image">
                                                        <img src="<?=_WEB_ROOT?>assets/admin/images/product/6.png" class="img-fluid"
                                                             alt="">
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="table-image">
                                                        <img src="<?=_WEB_ROOT?>assets/admin/images/product/7.png" class="img-fluid"
                                                             alt="">
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="table-image">
                                                        <img src="<?=_WEB_ROOT?>assets/admin/images/product/11.png"
                                                             class="img-fluid" alt="">
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="table-image">
                                                        <img src="<?=_WEB_ROOT?>assets/admin/images/product/8.png" class="img-fluid"
                                                             alt="">
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="table-image">
                                                        <img src="<?=_WEB_ROOT?>assets/admin/images/product/9.png" class="img-fluid"
                                                             alt="">
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="table-image">
                                                        <img src="<?=_WEB_ROOT?>assets/admin/images/product/10.png"
                                                             class="img-fluid" alt="">
                                                    </div>
                                                </td>
